      ...
      <ScrollView style={{backgroundColor: activeColors.bg, padding: SIZES.xLarge}}  showsVerticalScrollIndicator={false} >
        <View style={{ flex: 1, marginBottom: 15}} >
          <View style={[styles.subwrap, styles.subwrapLarge]}>
            <Text style={[styles.title ,{ color: activeColors.fg, flex: 1 }]}>Profile</Text>
            <Icon 
          ...
          <View style={styles.subwrap}>
            ...
            <View style={{flex: 1, flexDirection: "column", paddingHorizontal: SIZES.medium, justifyContent:"center"}}>
              ...
              <Text style={[styles.text, {color: activeColors.fg, opacity: 0.75, fontSize: SIZES.small}]}>Show profile</Text>
            </View>
            <Icon 
              name="right"
          ...
          {SECTIONS.map((_, index) => {
            return (
              <ProfileSection key={index} title={_.title} tabs={_.tabs}/>
            )
          })}  
        </View>
        <CustomButton 
